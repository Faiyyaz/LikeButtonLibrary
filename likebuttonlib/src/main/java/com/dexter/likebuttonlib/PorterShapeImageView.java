...
public class PorterShapeImageView extends PorterImageView {
    ...
    private void setup(Context context, AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PorterShapeImageView, defStyle, 0);
            shape = typedArray.getDrawable(R.styleable.PorterShapeImageView_shape);
            typedArray.recycle();
        }
        matrix = new Matrix();
    }
